/*
 ...
 https://github.com/jasonm23/angular.js-v1.1.5
 License: MIT

 Changes made to make IE8 compatible:
 Joris de Ruiter, Sense Observation Systems, Holland

	Changes to v1.1.5:
	1. Added console object creation if console does not exists
	2. Added check for IE8
	3. Made e.apply run only on IE > 8

	 e.apply gave problems, changed to:
	 if(ie<9){
		IE alternative method provided by angular
	 } else {
		normal apply method
	}
...
/*
* 1. If console not exists, create console object, to prevent error on console.log()
*/
if(!window.console) {console={}; console.log = function(){};}

/*
* 2. Check for IE8
* Function returns 8 for IE8, 9 for IE9, and undefined for IE10, IE11, Chrome and others
* Use with: if(ie<9) anywhere in code, var ie is a global variable.
*/
var ie = (function () {
    ...
    function Pc(b, a) {
        ...
        for (var l = [], u, o = 0, z = [],
            ...
            if (c("\"'"))k(r); else if (e(r) || c(".") && e(d()))j(); else if (i(r)) {
                ...
                G ? (l.push({index: o, text: n, fn: G}), o += 3) : A ? (l.push({index: o, text: x, fn: A}), o += 2) : v ? (l.push({
                    index: o,
        ...
        return {
            restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                function k(e, f, g) {
                    ...
                    var j = c(h[2] || h[1]), k = h[4] || h[6], l = h[5], m = c(h[3] || ""), n = c(h[2] ? h[1] : k), u = c(h[7]), t = h[8] ? c(h[8]) : null, w = [[{element: f, label: ""}]];
